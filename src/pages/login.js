    ...
    <div className="main mx-auto">
      <div className={`container a-container ${!isSignUp ? 'is-txl' : ''}`} id="a-container">
        <form id="a-form" className="form" onSubmit={handleSubmit}>
          <h2 className="form_title title">{isSignUp ? 'Create Account' : 'Sign in to Website'}</h2>
          ...
          <button className="form__button button submit"> {isSignUp ? 'SIGN UP' : 'SIGN IN'}</button>
        </form>
      </div>
      <div className={`container b-container ${isSignUp ? 'is-txl' : ''}`} id="b-container">
        <form id="b-form" className="form" onSubmit={handleSubmit}>
          <h2 className="form_title title">{isSignUp ? 'Sign in to Website' : 'Create Account'}</h2>
          <img
                className="form__icon"
                src="data:image/svg+xml;base64,"
                alt=""
          ...
          <button className="form__button button submit">{isSignUp ? 'SIGN IN' : 'SIGN UP'}</button>
        </form>
      </div>
      <div className="switch" id="switch-cnt">
        <div className={`switch__circle ${isSignUp ? '' : 'is-txr'}`} />
        <div className={`switch__circle switch__circle--t ${isSignUp ? 'is-txr' : ''}`} />
