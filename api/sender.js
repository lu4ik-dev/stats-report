...
function sendMailVerification(email, name) {
    const nodemailer = require('nodemailer');
                                                                      ...
                                                                      <td width="560" class="esd-container-frame" align="center" valign="top">
                                                                          <table cellpadding="0" cellspacing="0" width="100%">
                                                                              <tbody>
                                                                                  ...
                                                                                  <tr>
                                                                                      <td align="center" class="esd-block-text es-p10b es-m-txt-c">
                                                                                          <h1 style="font-size: 46px; line-height: 100%;">Активация</h1>
                                                                                      </td>
                                                                                  </tr>
                                                                                  <tr>
                                                                                      <td align="center" class="esd-block-text es-p5t es-p5b es-p40r es-p40l es-m-p0r es-m-p0l">
                                                                                          <p>Уважаемый ${name}, Ваша учетная запись была успешно активирована администратором.</p>
                                                                                      </td>
                                                                                  </tr>
                                                                              </tbody>
                                                                          </table>
